    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 p-4 bg-blue-100 rounded-xl border border-blue-300">
          <p className="font-bold text-blue-800 mb-2">📋 Panduan Setup Google Sheets:</p>
          <ol className="text-sm text-blue-700 space-y-1 list-decimal list-inside">
            <li>Buat Google Spreadsheet baru</li>
            <li>Buat 2 sheet: "Karyawan" dan "Pengajuan Cuti"</li>
            <li>Copy Google Apps Script code ke Apps Script Editor</li>
            <li>Deploy sebagai Web App dan copy URL</li>
            <li>Ganti GOOGLE_SCRIPT_URL di kode React dengan URL Web App Anda</li>
          </ol>
        </div>
      </div>
    </div>
